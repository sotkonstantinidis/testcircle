...
urlpatterns = patterns(
    ...
    url(r'^edit/new/$', GenericQuestionnaireView.as_view(url_namespace='technologies'),
        name='questionnaire_new'),
    url(r'^edit/(?P<identifier>[^/]+)/$', GenericQuestionnaireView.as_view(url_namespace='technologies'),
