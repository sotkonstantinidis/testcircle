        ...
        'questions': {
            'location_map': {
                'mapping': [
                    {
                        'wocat_table': 'approach',
                        'wocat_column': 'area_lat',
                    },
                    {
                        'wocat_table': 'approach',
                        'wocat_column': 'area_long',
                    }
                ],
                'type': 'dropdown',
                'composite': {
                ...
                'mapping': [
                    {
                        'mapping': [
                            {
                                'wocat_table': 'approach',
                                'wocat_column': 'area_total',
                            }
                        ],
                        'value_prefix': 'Total area covered by the SLM Approach is ',
                        'value_suffix': ' km2',
                    },
                    {
                        'mapping': [
                            {
                                'wocat_table': 'approach',
                                'wocat_column': 'area_approx',
                                'lookup_table': True,
                            }
                        ],
                        'value_prefix': 'Approximate area covered by the SLM Approach is '
                    },
                    {
                        'mapping': [
                            {
                                'wocat_table': 'approach',
                                'wocat_column': 'area_outline',
                            }
                        ],
                        'value_prefix': 'Boundary points of the Approach area: ',
                    }
                ],
                'type': 'string',
            }
...
for qg in questiongroups:
    qa_mapping.update(qg)

custom_mapping_messages = [
    {
        'message': 'Manually check whether Comments in QA 1.3.1 refer to the location (if yes, they have to be transferred to QCAT 2.5 Comments)',
        'ids': [39, 40, 41, 42, 46, 49, 50, 51, 52, 60, 61, 62, 63, 64, 67, 68,
                69, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 91, 92,
                93, 96, 97, 99, 100, 101, 104, 105, 106, 107, 112, 114, 116,
                118, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130,
                131, 132, 133, 134, 138, 139, 140, 141, 145, 146, 147, 149, 151,
                152, 153, 156, 157, 158, 159, 161, 162, 163, 166, 170, 171, 173,
                175, 176, 177, 178, 180, 181, 195, 199, 200, 201, 202, 203, 204,
                205, 206, 207, 208, 209, 211, 212, 222, 242, 243, 244, 245, 252,
                254, 269, 272, 274, 278, 281, 282, 288, 292, 294, 308, 309, 314,
                315, 322, 323, 328, 329, 332, 333, 334, 335, 336, 337, 339, 342,
                343, 345, 350, 355, 368, 369, 371, 378, 381, 382, 384, 386, 387,
                389, 390, 391, 392, 393, 394, 395, 397, 400, 403, 405, 406, 407,
                417, 418, 420, 421, 422, 424, 425, 427, 428, 429, 430, 431, 432,
                434, 441, 442, 444, 445, 446, 447, 449, 450, 455, 456, 457, 460,
                461, 463, 466, 467, 469, 470, 472, 473, 482, 487, 488, 489, 496,
                498, 499, 501, 506, 507, 508, 509, 510, 511, 513, 514, 516, 517,
                518, 519, 520, 522, 523, 524, 526, 527, 528, 529, 530, 532, 533,
                535, 536, 537, 538, 539, 540, 542, 544, 545, 546, 547, 548, 549,
                550, 551, 552, 553, 554, 555, 556, 557, 559, 578, 581, 585, 587,
                588, 591, 597, 598, 600, 601, 604, 605, 606, 619, 620, 623, 624,
                629, 641, 644, 645, 646]
    },
    {
        'message': 'This approach contains a GoogleEarth file.',
        'ids': [70, 71, 72, 73, 221, 242, 243, 244, 245, 252, 254, 269, 272,
                274, 275, 276, 277, 283, 284, 285, 288, 292, 293, 294, 307, 308,
                309, 313, 314, 315, 322, 323, 325, 326, 328, 329, 331, 336, 337,
                346, 349, 350, 351, 352, 354, 355, 356, 358, 359, 360, 361, 366,
                367, 368, 369, 370, 371, 372, 373, 382, 383, 384, 385, 386, 387,
                389, 391, 392, 394, 395, 397, 399, 400, 418, 420, 424, 427, 428,
                429, 430, 431, 432, 434, 436, 437, 438, 439, 444, 446, 453, 456,
