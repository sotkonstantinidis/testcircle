...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='translation',
            field=models.ForeignKey(null=True, to='configuration.Translation', blank=True),
