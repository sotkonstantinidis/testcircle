...
class QuestionnaireModelTest(TestCase):
    ...
    def test_create_new_returns_new_object(self):
        returned = Questionnaire.create_new(
            configuration_code='unccd', data={'foo': 'bar'})
    ...
    def test_create_new_calls_configuration_get_active_by_code(
        ...
        Questionnaire.create_new(configuration_code='unccd', data={})
        mock_Configuration_get_active_by_code.assert_called_once_with('unccd')
    ...
    def test_create_new_adds_configuration(self):
        configuration = Configuration.get_active_by_code('unccd')
        ret = Questionnaire.create_new(configuration_code='unccd', data={})
